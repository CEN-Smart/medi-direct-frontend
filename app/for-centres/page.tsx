...
import { ForCentres } from '@/components/for-centers';

export const metadata: Metadata = {
    title: 'For Centres - Medi Direct',
    description:
    ...
    authors: [
        {
            ...
            url: 'https://medidirect.org/for-centres',
        },
    ],
...
const ForCentresPage = () => {
    return <ForCentres />;
};

export default ForCentresPage;
