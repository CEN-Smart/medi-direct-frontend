...
import { BarChart3, Calendar, Shield, TrendingUp, Users } from 'lucide-react';
...
const features = [
    {
        ...
        description:
            "Fill empty slots and maximize your centre's utilization rate.",
    ...
    },
    {
        ...
        description:
            'Connect with patients actively searching for diagnostic services.',
    ...
    },
    {
        ...
        description:
            'Automated booking system that syncs with your availability.',
        stat: '24/7 booking',
    },
    {
        icon: BarChart3,
        ...
        description:
            'Track bookings, revenue, and patient feedback in real-time.',
...
export function ForCentres() {
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <section
                ref={heroRef}
                className="bg-linear-to-br from-green-50 to-blue-50 py-20"
            >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-gray-600 mb-8">
                                Join MediDirect and connect with thousands of
                                patients looking for quality diagnostic
                                services. Increase your bookings and revenue
                ...
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600">
                            Everything you need to grow your diagnostic centre
                        </p>
                    </div>
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600">
                            Hear from diagnostic centres already growing with
                            MediDirect
                        </p>
                    </div>
            ...
            <section className="py-20 bg-green-600">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <p className="text-xl text-green-100 mb-8 max-w-2xl mx-auto">
                        Join hundreds of diagnostic centres already growing
                        their business with MediDirect.
                    </p>
