...
export function TwoFactorAuthModal({
    ...
    const handleVerification = async () => {
        ...
        try {
            ...
            setErrors({
                code: 'Invalid verification code. Please try again.' + error,
            });
        } finally {
            setIsLoading(false);
        }
                    ...
                    <div className="space-y-4">
                        <Alert>
                            ...
                            <AlertDescription>
                                ...
                                for your account. Your account is protected with
                                ...
                                <div className="flex items-start gap-3 p-4 border rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 text-sm">
                                            ...
                                            Authy, or Microsoft Authenticator to
                ...
                {step === 3 && (
                    <div className="space-y-4">
                        ...
                        <Alert>
                            ...
                            <AlertDescription>
                                <strong>Important:</strong> Save these backup
                                codes in a safe place. You can use them to
                        ...
                        <div className="space-y-3">
                            ...
                            <p className="text-gray-500 text-xs">
                                Each backup code can only be used once. Generate
                                new codes if you run out.
                            </p>
                        </div>
